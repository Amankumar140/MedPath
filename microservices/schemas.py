...
class PatientContext(BaseModel):
    ...
    latitude: Optional[float] = Field(None, description="Patient's latitude coordinate from GPS or saved location.")
    longitude: Optional[float] = Field(None, description="Patient's longitude coordinate from GPS or saved location.")
    formatted_address: Optional[str] = Field(None, description="Full formatted address string.")
    city: Optional[str] = Field(None, description="Patient's city extracted from location.")
